...
**D-36-01 — Establish what is actually broken before building.** Drive the full procure-to-pay
...
**D-36-02 — The MANAGER 403 is a permission-model question, not a grant to hand out.**
...
**D-36-03 — Approval limits are tenant-managed in the UI.** An owner sets them per role or per
user. No SQL, no seed, no support ticket.

**D-36-04 — A PO line must reference an ingredient that exists, refused at the API with a usable
...
**D-36-05 — Unit conversion is the highest-risk arithmetic here.** Both directions have already
...
**D-36-06 — Stock and ingredient management must be complete CRUD in the UI**, including
