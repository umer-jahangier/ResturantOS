...
**D-35-01 — Anything with a known set of values is a select, not a text field.**
...
**D-35-02 — Validation is live, on the field, as the user types — not on submit.**
...
**D-35-03 — Errors name the field, the rule and the fix. Server errors are mapped, never raw.**
...
**D-35-04 — One shared form stack, not a per-screen reinvention.**
...
**D-35-05 — HR must be operable end to end without SQL.**
...
**D-35-06 — The pattern is documented and adopted, not just built.**
