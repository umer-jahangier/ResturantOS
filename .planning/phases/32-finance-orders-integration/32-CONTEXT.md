...
**D-32-01 — A transactions view is the centrepiece, and it must be traceable end to end.**
...
**D-32-02 — Daily takings, reconciled, as the finance landing screen.**
...
**D-32-03 — The guide is a first-class tab, written for a restaurant owner, not an accountant.**
...
**D-32-04 — Fix the integration gaps 22b found and could not fix in its lane.**
...
**D-32-05 — Never invent a number.** If a figure cannot be computed, say so and say why. The
