...
**D-34-01 — Depth and motion are added ON TOP of phase 20's tokens, never around them.**
...
**D-34-02 — Richness is zoned. This is the decision that keeps the product fast.**
...
**D-34-03 — Motion respects `prefers-reduced-motion`, always.**
...
**D-34-04 — Glass must degrade.** `backdrop-filter` is unsupported or disabled in real
...
**D-34-05 — No animation library is added without justification.** CSS transitions and
...
**D-34-06 — "3D" means depth, not literal 3D.** Layered shadows, subtle transforms on hover,
