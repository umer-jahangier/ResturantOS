...
if [[ "$SKIP_BUILD" != true ]]; then
  ...
  mvn -pl services/auth-service,services/authorization-service,services/user-service,services/platform-admin-service,services/audit-service,services/file-service,services/finance-service,services/pos-service,services/kitchen-service,services/inventory-service,services/purchasing-service,gateway \
