...
const LIGHT: readonly Row[] = [
  ...
  ["text-primary on surface-2 --neutral-100", "--neutral-950", "--neutral-100", 17.51, "AAA"],
...
const DARK: readonly Row[] = [
  ...
  ["focus ring --primary-400 on surface-0", "--primary-400", "--neutral-1000", 9.64, "SC-1.4.11"],
  [
  ...
  ["--success-300 on surface-0", "--success-300", "--neutral-1000", 12.37, "AAA"],
