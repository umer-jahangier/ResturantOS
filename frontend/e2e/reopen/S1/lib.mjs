/*
 * S1 RE-OPEN — independent harness. Copied from e2e/shift/lib.mjs, output pointed at
 * .planning/audits/reopen/S1 so nothing here can be confused with the claimant's shots.
 */
...
export const OUT = resolve(process.cwd(), "../.planning/audits/reopen/S1");
