/*
 * S1 RE-OPEN — independent harness. Copied from e2e/floor/S1/lib.mjs, output pointed at
 * .planning/audits/floor/S1-reopen and the persona table extended with the CONTROL tenant
 * (cross-tenant probes) and the non-manage personas (wrong-persona probes).
 */
...
export const OUT = resolve(process.cwd(), "../.planning/audits/floor/S1-reopen");
...
export async function login(page, who) {
  ...
  if (state !== "in") throw new Error(`login failed for ${who.email} — ${state} — url ${page.url()}`);
