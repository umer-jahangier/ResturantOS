...
/**
 * Guards /internal/** with constant-time X-Internal-Service secret check (Doc 4 §4.1).
 */
@Component
public class FinanceInternalServiceFilter extends OncePerRequestFilter {

    public static final String HEADER = "X-Internal-Service";

    private final byte[] secretBytes;

    public FinanceInternalServiceFilter(
