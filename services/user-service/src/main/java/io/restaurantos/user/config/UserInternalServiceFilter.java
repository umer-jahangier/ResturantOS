...
/**
 * Guards /internal/users/** paths with a constant-time X-Internal-Service secret check.
 * Mirrors auth-service InternalServiceFilter — extracted to shared-lib in a future cleanup.
 */
@Component
public class UserInternalServiceFilter extends OncePerRequestFilter {

    public static final String HEADER = "X-Internal-Service";

    private final byte[] secretBytes;

    public UserInternalServiceFilter(
