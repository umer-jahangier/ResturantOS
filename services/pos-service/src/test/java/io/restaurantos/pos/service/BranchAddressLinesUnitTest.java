 ...
 */
class BranchAddressLinesUnitTest {
    ...
    void plainAddressStartingWithADigitIsPrinted() {
        assertThat(BranchAddressLines.of("12 Khayaban-e-Iqbal, F-7 Markaz, Islamabad"))
    ...
    void plainAddressStartingWithALetterIsPrinted() {
        assertThat(BranchAddressLines.of("Islamabad"))
    ...
    void numericOnlyAddressIsPrinted() {
        assertThat(BranchAddressLines.of("44000")).containsExactly("44000");
    }

    @Test
    @DisplayName("newlines separate printed lines; blank lines and stray spacing do not print")
    void newlinesBecomeLines() {
        assertThat(BranchAddressLines.of("12 Khayaban-e-Iqbal\n\n  F-7 Markaz  \nIslamabad"))
                .containsExactly("12 Khayaban-e-Iqbal", "F-7 Markaz", "Islamabad");
    }
    ...
    void nullAndBlankProduceNoLines() {
        assertThat(BranchAddressLines.of(null)).isEmpty();
        assertThat(BranchAddressLines.of("")).isEmpty();
        assertThat(BranchAddressLines.of("   ")).isEmpty();
    }
    ...
    void jsonLookingTextIsPrintedVerbatim() {
        assertThat(BranchAddressLines.of("{\"city\": \"Karachi\"}"))
