...
/**
 * Guards /internal/** with constant-time X-Internal-Service secret check.
 */
@Component
public class InventoryInternalServiceFilter extends OncePerRequestFilter {

    public static final String HEADER = "X-Internal-Service";

    private final byte[] secretBytes;

    public InventoryInternalServiceFilter(
